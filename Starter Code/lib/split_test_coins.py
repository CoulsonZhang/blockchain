...
if __name__ == '__main__':
    ...
    # private_key = 'cQ2NqKDTgCNT65ghFL2C8gE4YBNo2bwTaJBMrMGfywsfuAFqHsnR'
    private_key = CBitcoinSecret('cQ2NqKDTgCNT65ghFL2C8gE4YBNo2bwTaJBMrMGfywsfuAFqHsnR')
    public_key = private_key.pub
    address = P2PKHBitcoinAddress.from_pubkey(public_key)

    amount_to_send = 0.018 # amount of BTC in the output you're splitting minus fee
    txid_to_spend = (
        '2d3b1a529a731b1296d97ecf02caca68afa7e7fdeddc14a3af3bbb093a191bac')
